...
тега `div` имеющего класс `news__item`, то нам остается лишь найти тег `img` внутри тега `a` и получить его аттрибут `src`.
...
Использование jspoon для парсинга значительно сокращает объем кода, требуемый для обработки и извлечени необходимых вам данных, а гибкий и богатый возможностями синтаксис селекторов позволит извлекать данные из html-кода практически любой сложности.